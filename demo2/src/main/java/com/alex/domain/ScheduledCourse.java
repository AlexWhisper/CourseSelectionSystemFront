...
//    private int capacity;//课容量
    ...
    public ScheduledCourse(String courseNo, int classNo, String dayOfWeek, String timeOfDay, String room, int capacity) {
    ...
    public EnrollmentStatus enroll(Student student) {
        if (enrolledStudent.size() >= capacity) {
            ...
            if (!enrolledStudent.containsKey(student.getId())) {
                enrolledStudent.put(getFullScheduleCourseNo(), student);
